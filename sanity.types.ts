...
export type ACTIVE_COUPON_CODE_RESULT = {
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
...
export type SALE_QUERY_RESULT = Array<{
  _id: string;
  _type: "sale";
  _createdAt: string;
  _updatedAt: string;
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type == 'sale' && isActive == true && couponCode == $couponCode] | order(validFrom desc)[0]": ACTIVE_COUPON_CODE_RESULT;
